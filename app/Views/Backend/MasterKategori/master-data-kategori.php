            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3>Master Data Kategori
                        <a href="<?= base_url('admin/input-data-kategori');?>"><button type="button" class="btn btn-sm btn-primary pull-right">Input Data Kategori</button></a>
                    </h3>
                    <hr />
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-sortable="true">
                                    <a href="<?= base_url('admin/edit-data-kategori/'.sha1($data['id_kategori']));?>"><button type="button" class="btn btn-sm btn-success">Edit</button></a>
