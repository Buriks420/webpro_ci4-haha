        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3>Master Data Rak
                        <a href="<?= base_url('admin/input-data-rak');?>"><button type="button" class="btn btn-sm btn-primary pull-right">Input Data Rak</button></a>
                    </h3>
                    <hr />
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-sortable="true">
                                    <a href="<?= base_url('admin/edit-data-rak/'.sha1($data['id_rak']));?>"><button type="button" class="btn btn-sm btn-success">Edit</button></a>
